...
*
PyArray_GetField(PyArrayObject
*self,
PyArray_Descr *typed,
int offset
)
...
_may_have_objects (PyArray_DESCR(self))

||
_may_have_objects(typed)
) {
...
PyArray_SetField(PyArrayObject *self, PyArray_Descr *dtype,
    ...
    retval = PyArray_CopyObject((PyArrayObject * )
    ret, val);
    Py_DECREF(ret);
    return retval;
}
...
NPY_NO_EXPORT PyObject
*
PyArray_Byteswap(PyArrayObject
*self,
npy_bool inplace
)
{
...
if (inplace) {
if (
PyArray_FailUnlessWriteable(self,
"array to be byte-swapped") < 0) {
return
NULL;
}
...
copyswapn(PyArray_DATA(self), PyArray_DESCR(self)

->elsize, NULL, -1, size, 1, self);
}
else { /* Use iterator */
int axis = -1;
npy_intp stride;
it = (PyArrayIterObject *) \
                PyArray_IterAllButAxis((PyObject * )
self, &axis);
stride = PyArray_STRIDES(self)[axis];
size = PyArray_DIMS(self)[axis];
while (it->index < it->size) {
copyswapn(it
->dataptr, stride, NULL, -1, size, 1, self);
...
array_astype(PyArrayObject *self,
    ...
    Py_SETREF(dtype, PyArray_AdaptDescriptorToArray(self, (PyObject * )
    dtype));
    if (dtype == NULL) {
        return NULL;
    }
...
NPY_NO_EXPORT PyObject
*
array_ufunc(PyArrayObject
*
NPY_UNUSED(self), PyObject
*args,
PyObject *kwds
)
{
...
static PyObject *
        array_function(PyArrayObject *NPY_UNUSED(self), PyObject
...
PyArg_ParseTupleAndKeywords(
        c_args, c_kwds,
"OOOO:__array_function__", kwlist,
...
array_repeat(PyArrayObject *self, PyObject *args, PyObject *kwds) {
    ...
    PyArray_Repeat(self, repeats, axis));
}
...
array_partition(PyArrayObject *self,
    ...
    ktharray = (PyArrayObject * )
    PyArray_FromAny(kthobj, NULL, 0, 1,
...
array_searchsorted(PyArrayObject *self,
    ...
    return PyArray_Return((PyArrayObject * )
    PyArray_SearchSorted(self, keys, side, sorter));
}
...
array_deepcopy(PyArrayObject *self, PyObject *args) {
    ...
    copied_array = (PyArrayObject * )
    PyArray_NewCopy(self, NPY_KEEPORDER);
...
_getlist_pkl(PyArrayObject *self) {
    ...
    iter = (PyArrayIterObject *) PyArray_IterNew((PyObject * )
    self);
    if (iter == NULL) {
        return NULL;
    }
...
PyDataType_FLAGCHK(PyArray_DESCR(self), NPY_LIST_PICKLE
...
array_reduce_ex_regular(PyArrayObject *self, int NPY_UNUSED(protocol)) {
    ...
    subclass_array_reduce = PyObject_GetAttrString((PyObject * )
    self,
            "__reduce__");
...
array_reduce_ex_picklebuffer(PyArrayObject *self, int protocol) {
    ...
    PyArray_IS_F_CONTIGUOUS((PyArrayObject * )
    self)) {
        ...
        order = 'F';
        transposed_array = PyArray_Transpose((PyArrayObject * )
        self, NULL);
    ...
    return Py_BuildValue("N(NONN)",
                         from_buffer_func, buffer, (PyObject * )
    descr,
            PyObject_GetAttrString((PyObject * )
    self, "shape"),
...
array_dot(PyArrayObject *self,
    ...
    ret = (PyArrayObject * )
    PyArray_MatrixProduct2(a, b, (PyArrayObject * )
    o);
...
array_diagonal(PyArrayObject *self, PyObject *args, PyObject *kwds) {
    ...
    ret = (PyArrayObject * )
    PyArray_Diagonal(self, offset, axis1, axis2);
    return PyArray_Return(ret);
}
...
if (!
PyArray_CanCastArrayTo(self, dtype, NPY_SAME_KIND_CASTING
) &&
!(
PyArray_TYPE(self)
== NPY_OBJECT)) {
PyObject *descr = (PyObject * )
PyArray_DESCR(self);
