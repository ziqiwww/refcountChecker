...
*
_PyArray_ArgMinMaxCommon(PyArrayObject
*op,
int axis, PyArrayObject
*out,
int keepdims,
        npy_bool
is_argmax)
...
ap = (PyArrayObject * )
PyArray_ContiguousFromAny((PyObject
*)op,
PyArray_DESCR(op)
->type_num, 1, 0);
Py_DECREF(op);
 ...
 */
memcpy(out_shape, original_op_shape, out_ndim
* sizeof(npy_intp));
out_shape[axis] = 1;
}
}
...
NPY_NO_EXPORT PyObject
*
_PyArray_ArgMaxWithKeepdims(PyArrayObject
*op,
int axis, PyArrayObject
*out,
int keepdims
...
{
return
_PyArray_ArgMinMaxCommon(op, axis, out, keepdims,
1);
}
...
{
return
_PyArray_ArgMinMaxCommon(op, axis, out,
0, 1);
}

NPY_NO_EXPORT PyObject
*
_PyArray_ArgMinWithKeepdims(PyArrayObject
*op,
int axis, PyArrayObject
*out,
int keepdims
...
NPY_NO_EXPORT PyObject
*
PyArray_Std(PyArrayObject
*self,
int axis,
int rtype, PyArrayObject
*out,
int variance
)
{
return
__New_PyArray_Std(self, axis, rtype, out, variance,
0);
}

NPY_NO_EXPORT PyObject
*
__New_PyArray_Std(PyArrayObject
*self,
int axis,
int rtype, PyArrayObject
*out,
...
arrnew = (PyArrayObject * )
PyArray_CheckAxis(self,
&axis, 0);
if (arrnew == NULL) {
return
NULL;
...
PyArray_EnsureAnyArray (
PyArray_GenericBinaryFunction((PyObject *)
...
if (
PyArray_ISCOMPLEX(arr2)
) {
obj3 = PyObject_GetAttrString((PyObject * )
arr2, "real");
switch(rtype) {
case NPY_CDOUBLE:
rtype = NPY_DOUBLE;
...
obj1 = PyArray_GenericReduceFunction((PyArrayObject * )
obj3, n_ops.add,
axis, rtype, NULL);
Py_DECREF(obj3);
Py_DECREF(arr2);
...
if (out) {
if (
PyArray_AssignArray(out, (PyArrayObject
*)ret,
...
ret = PyArray_GenericReduceFunction((PyArrayObject * )
arr, n_ops.add, axis,
rtype, out);
Py_DECREF(arr);
return
...
ret = PyArray_GenericAccumulateFunction((PyArrayObject * )
arr,
n_ops.add, axis,
rtype, out);
Py_DECREF(arr);
...
NPY_NO_EXPORT PyObject
*
PyArray_Round(PyArrayObject
*a,
int decimals, PyArrayObject
*out)
{
...
part = PyObject_GetAttrString((PyObject * )
a, "real");
if (part == NULL) {
Py_DECREF(arr);
return
...
round_part = PyArray_Round((PyArrayObject * )
part,
decimals, NULL);
Py_DECREF(part);
if (round_part == NULL) {
...
PyArray_Empty(PyArray_NDIM(a), PyArray_DIMS(a),
        my_descr,
        PyArray_ISFORTRAN(a)
...
tmp = PyArray_CastToType((PyArrayObject * )
ret,
...
_slow_array_clip(PyArrayObject *self, PyObject *min, PyObject *max, PyArrayObject *out) {
    ...
    if (min != NULL) {
        res2 = _GenericBinaryOutFunction((PyArrayObject * )
        res1,
...
NPY_NO_EXPORT PyObject
*
PyArray_Clip(PyArrayObject
*self,
PyObject *min, PyObject
*max,
PyArrayObject *out
)
{
...
if (min == NULL) {
return
PyObject_CallFunctionObjArgs(n_ops
.minimum, self, max, out, NULL);
}
else if (max == NULL) {
return
PyObject_CallFunctionObjArgs(n_ops
.maximum, self, min, out, NULL);
}
else {
return
PyObject_CallFunctionObjArgs(n_ops
.clip, self, min, max, out, NULL);
}
}
...
|| (out &&
PyArray_ISBYTESWAPPED(out)
)) {
return
_slow_array_clip(self, min, max, out
);
}
 ...
 */
if (
PyArray_ScalarKind(newdescr
->type_num, NULL) >

PyArray_ScalarKind (PyArray_DESCR(self)
...
if (!
PyDataType_ISNOTSWAPPED(indescr)
) {
...
Py_INCREF(indescr);
newin = (PyArrayObject * )
PyArray_FromArray(self, indescr, flags
);
if (newin == NULL) {
goto
fail;
...
Py_INCREF(indescr);
newout = (PyArrayObject * )
PyArray_FromArray(out, indescr, oflags
);
if (newout == NULL) {
goto
fail;
...
NPY_NO_EXPORT PyObject
*
PyArray_Conjugate(PyArrayObject
*self,
PyArrayObject *out
)
{
if (
PyArray_ISCOMPLEX(self)
||
PyArray_ISOBJECT(self)
||
PyArray_ISUSERDEF(self)
) {
if (out == NULL) {
return
PyArray_GenericUnaryFunction(self,
        n_ops
.conjugate);
}
else {
